...
Phys_hBulb=DrawPlate(Phys_hBulbTransform,L/4,'none',2,'--');
...
Kal_hBulb=DrawPlate(Kal_hBulbTransform,L/4,'red',2,'-');
...
legend([Kal_hString,Phys_hString],{'Linear Kalman','Physics'})
